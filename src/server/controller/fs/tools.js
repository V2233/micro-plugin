...
export function getDir(path, depth = 1) {
    if (depth) {
...
export function unlinkedPath(path) {
...
export function fuzzyMatchInDirectoryTree(dirPath, keyword) {
    const matchedItems = [];
...
export function filterDirectoryTree(tree, extension) {
...
export function calculateFileSize(filePath) {
...
export async function calculateTotalSize(tree) {
    let totalSize = 0;
